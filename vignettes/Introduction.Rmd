...
The **SISE** package also provides a helpful function, `predict.onset()`, for imputing censored observations given an assumed onset distribution estimate. To demonstrate, we predict onsets of left- and interval-censored individuals in the two groups, given the estimated smoothed onset curves. 
